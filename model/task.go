...
type TaskBillingContext struct {
	...
	InputVideoSeconds        int                `json:"input_video_seconds,omitempty"`          // 网关探测的输入参考视频总秒数
	InputVideoPricePerSecond float64            `json:"input_video_price_per_second,omitempty"` // 提交时的输入视频每秒附加费快照
