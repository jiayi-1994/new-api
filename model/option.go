...
func InitOptionMap() {
	...
	common.OptionMap[ratio_setting.VideoResolutionBillingUnitOptionKey] = ratio_setting.VideoResolutionBillingUnit2JSONString()
...
func validateOptionValue(key string, value string) error {
	...
	case ratio_setting.VideoResolutionBillingUnitOptionKey:
		return ratio_setting.ValidateVideoResolutionBillingUnitByJSONString(value)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case ratio_setting.VideoResolutionBillingUnitOptionKey:
		err = ratio_setting.UpdateVideoResolutionBillingUnitByJSONString(value)
	case ratio_setting.VideoInputSecondPriceOptionKey:
